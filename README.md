...
個人活動と `company` 運用をまとめるリポジトリ。

## 目的

- 日々のTODO、意思決定、学び、プロジェクト状況を一箇所に集約する
- `company` の秘書室・PM・クリエイティブ・開発の流れをGitHub上でも追えるようにする
- SNSコンテンツ制作とRemotion動画制作の進捗を継続的に残す
...
- [Decisions](company/decisions/README.md)

## 運用方針

- TODOは `company/todos/YYYY-MM-DD.md` に日次で記録する
