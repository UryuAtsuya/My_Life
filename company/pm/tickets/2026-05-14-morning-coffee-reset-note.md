...
`company/todos/2026-05-14.md` のMorning Handoffに従い、今日の昼制作ではコーヒー単体記事 `毎朝のコーヒーを、仕事前の小さなリセットにする` を本文化する。AI朝会の説明に寄せすぎず、生活、習慣、仕事前の整え方を主軸にする。
...
- コーヒー市場解説に寄せすぎない。朝の仕事開始前のリセットを主題にする。
- AI運用の説明は本文中心にしない。今日のコーヒー単体レーンを守る。
- 数値や実績は捏造しない。統計や外部情報は参考リンク付きで扱う。
